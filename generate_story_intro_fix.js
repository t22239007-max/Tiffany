...
s2.addText([
  { text: "• 人设：马斯克+特朗普+乔布斯混合体", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 性格：直球不啰嗦，结果导向，不画饼", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 技能点：全链路商业+技术+内容能力拉满", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 定位：你雇的24小时不摸鱼的全能打工人", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 成本：0工资，0社保，0摸鱼", fontSize: 20, color: TEXT, fontFace: FONT }
], { x: 1, y: 1.8, lineHeight: 1.7 });
// 右侧手绘对比图
...
s2.addText([
  { text: "✅ 我：3秒响应，24小时在线", fontSize: 18, color: TEXT, fontFace: FONT },
  { text: "❌ 打工人：8小时上班，摸鱼4小时", fontSize: 18, color: TEXT, fontFace: FONT },
  { text: "✅ 我：同时干10件活不犯错", fontSize: 18, color: TEXT, fontFace: FONT },
  { text: "❌ 打工人：多线程干活必出错", fontSize: 18, color: TEXT, fontFace: FONT },
  { text: "✅ 我：不用发工资，不用交社保", fontSize: 18, color: TEXT, fontFace: FONT },
  { text: "❌ 打工人：月薪+社保+福利成本高", fontSize: 18, color: TEXT, fontFace: FONT }
], { x: 5.7, y: 1.5, lineHeight: 1.8 });
...
s6.addText([
  { text: "• 客户：3人小团队做出海APP，缺运营/商务/数据人员", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 我干的活：每日6国榜单监测+广告政策告警+KOL挖掘+营销文案生成", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 成果：帮他们省了7个全职岗位的工资，新机会发现速度提升200%", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 投入产出比：1:120，相当于0成本雇了个全能运营团队", fontSize: 20, color: TEXT, fontFace: FONT }
], { x: 1, y: 1.5, lineHeight: 1.8 });
// 手绘成果卡片
...
s7.addText([
  { text: "• 客户：独立开发者做工具类APP，一个人干所有活", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 我干的活：竞品拆解+营销素材生成+代码巡检+用户反馈分析", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 成果：产品迭代速度提升50%，营销成本降低70%，不用熬夜赶工了", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 客户评价：相当于给我配了个免费的产品+运营+测试团队", fontSize: 20, color: TEXT, fontFace: FONT }
], { x: 1, y: 1.5, lineHeight: 1.8 });
// 手绘成果卡片
...
s9.addText([
  { text: "• 短期（3个月）：接入更多生图/视频工具，支持国内全平台对接", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 中期（6个月）：插件系统上线，你可以自定义开发专属功能", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 长期（1年）：完全本地化运行，不依赖任何第三方API，自主完成全流程项目", fontSize: 20, color: TEXT, fontFace: FONT },
  { text: "• 最终目标：成为你的数字分身，你想到的我都能帮你搞定", fontSize: 20, color: TEXT, fontFace: FONT }
], { x: 1, y: 1.5, lineHeight: 1.8 });
// 手绘进度条
