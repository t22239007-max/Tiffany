...
slide1.addText("功能细化分类版 · 100%WPS兼容可编辑", {
  x: 0.5,
  y: 2.8,
  w: 9,
  fontSize: 28,
...
slide4.addText([
  ...
  { text: "• 多智能体项目团队：自动组建市场/技术/数据/运营/BD5人团队，自动分工输出项目落地方案，不用你协调", fontSize: 20, fontFace: "微软雅黑" },
...
// 生成WPS兼容版
pptx.writeFile({ fileName: "/root/.openclaw/workspace/龙虾AI自我介绍_功能细化分类版.pptx" })
  .then(() => console.log("✅ 功能细化分类版PPT生成成功，100%WPS兼容可编辑"));
