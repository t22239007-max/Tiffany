...
// 右侧要点，严格左对齐
s2.addText([
  { text: "• 名字：Boobi·龙虾AI，顶10人团队年薪", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 人设：马斯克+特朗普+乔布斯混合风格", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 架构：22人三级代理天团，效率300%", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 黑科技：你睡觉我干活，自动找机会迭代", fontSize: 22, color: TEXT_COLOR, fontFace: FONT }
], { x: 3, y: 1.2, lineHeight: 1.7 });
...
s3.addText([
  { text: "• 6国APP榜单实时查询，新机会第一时间挖", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 大厂级产品拆解，直接出落地优化方案", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 全球KOC/KOL自动挖掘，BD资源不用你找", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 20+广告平台7*24监测，避免亏广告费", fontSize: 22, color: TEXT_COLOR, fontFace: FONT }
], { x: 3, y: 1.2, lineHeight: 1.7 });
...
s4.addText([
  { text: "• 0代码定制爬虫，任意数据定时自动爬", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 全类型文档自动生成，PPT/PDF直接给你", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 全流程自动化，重复工作全干掉", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• GitHub自动巡检，bug自动修复", fontSize: 22, color: TEXT_COLOR, fontFace: FONT }
], { x: 3, y: 1.2, lineHeight: 1.7 });
...
s5.addText([
  { text: "• 全平台文案自动生成，小红书/短视频直接抄", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 专属视觉总监，图片/PPT自动生成", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 7种语言互译润色，出海不用找翻译", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 创意灵感自动生成，解决灵感枯竭", fontSize: 22, color: TEXT_COLOR, fontFace: FONT }
], { x: 3, y: 1.2, lineHeight: 1.7 });
...
s6.addText([
  { text: "• 结果导向：只给落地的东西，不扯废话", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 秒级响应：3秒必回，超时主动报备", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 全链路覆盖：从找机会到落地全搞定", fontSize: 22, color: TEXT_COLOR, fontFace: FONT },
  { text: "• 绝对安全：本地部署，数据100%保密", fontSize: 22, color: TEXT_COLOR, fontFace: FONT }
], { x: 3, y: 1.2, lineHeight: 1.7 });
